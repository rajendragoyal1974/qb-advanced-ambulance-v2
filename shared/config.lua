...
Config.Healthcare = {
    ...
    tests = {
        physical = { label = 'Physical Examination', category = 'Examination', price = 300, duration = 7000, animation = 'clipboard' },
        vitals = { label = 'Vital Signs', category = 'Examination', price = 200, duration = 6000, animation = 'clipboard' },
        blood_cbc = { label = 'Complete Blood Count', category = 'Laboratory', price = 400, duration = 9000, animation = 'blood' },
        blood_metabolic = { label = 'Metabolic Panel', category = 'Laboratory', price = 450, duration = 9000, animation = 'blood' },
        blood_type = { label = 'Blood Group and Rh', category = 'Laboratory', price = 250, duration = 9000, animation = 'blood' },
        toxicology = { label = 'Toxicology Screen', category = 'Laboratory', price = 600, duration = 9000, animation = 'blood' },
        urinalysis = { label = 'Urinalysis', category = 'Laboratory', price = 300, duration = 7000, animation = 'clipboard' },
        ecg = { label = '12-Lead ECG', category = 'Cardiology', price = 500, duration = 10000, animation = 'machine' },
        xray_chest = { label = 'Chest X-Ray', category = 'Imaging', price = 800, duration = 12000, animation = 'xray' },
        xray_head = { label = 'Head X-Ray', category = 'Imaging', price = 750, duration = 12000, animation = 'xray' },
        xray_limb = { label = 'Limb X-Ray', category = 'Imaging', price = 700, duration = 12000, animation = 'xray' },
        ct_scan = { label = 'CT Scan', category = 'Imaging', price = 1800, duration = 15000, animation = 'xray' },
        mri = { label = 'MRI Scan', category = 'Imaging', price = 2500, duration = 18000, animation = 'xray' },
        ultrasound = { label = 'Ultrasound', category = 'Imaging', price = 1200, duration = 12000, animation = 'machine' }
    },
    surgeries = {
